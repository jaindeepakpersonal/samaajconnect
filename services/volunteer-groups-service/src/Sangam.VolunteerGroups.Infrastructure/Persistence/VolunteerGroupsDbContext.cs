...
public sealed class VolunteerGroupsDbContext(
    DbContextOptions<VolunteerGroupsDbContext> options,
    ITenantContext tenantContext)
    : DbContext(options)
{
    private static readonly JsonSerializerOptions PayloadSerializerOptions = new(JsonSerializerDefaults.Web);

    public DbSet<VolunteerGroup> Groups => Set<VolunteerGroup>();

    public DbSet<GroupApplication> Applications => Set<GroupApplication>();
    ...
    {
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(VolunteerGroupsDbContext).Assembly);
