...
public sealed class SocialIssuesDbContext(
    DbContextOptions<SocialIssuesDbContext> options,
    ITenantContext tenantContext)
    : DbContext(options)
{
    private static readonly JsonSerializerOptions PayloadSerializerOptions = new(JsonSerializerDefaults.Web);

    public DbSet<SocialIssue> Issues => Set<SocialIssue>();

    public DbSet<IssueStatusHistory> IssueHistory => Set<IssueStatusHistory>();
    ...
    {
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(SocialIssuesDbContext).Assembly);
