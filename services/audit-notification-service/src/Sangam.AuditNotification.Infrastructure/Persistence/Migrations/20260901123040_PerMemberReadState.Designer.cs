...
namespace Sangam.AuditNotification.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260901123040_PerMemberReadState")]
    partial class PerMemberReadState
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sangam.AuditNotification.Domain.Notifications.Notification", b =>
                {
                    ...
                    b.Property<Guid?>("DeliveryClaimId")
                        .HasColumnType("uuid")
                        .HasColumnName("delivery_claim_id");
                    ...
                    b.HasIndex("DeliveryClaimId")
                        .HasDatabaseName("ix_notifications_delivery_claim_id");

                    b.HasIndex("SourceMessageId", "Channel")
                        .IsUnique()
                        .HasDatabaseName("ix_notifications_source_message_id_channel");
