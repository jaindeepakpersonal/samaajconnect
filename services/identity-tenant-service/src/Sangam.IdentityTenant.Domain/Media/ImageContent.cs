...
/// living in a service's own database stays reasonable. The aggregate that
/// holds them, in each service that has one, says why they live there rather
/// than in an object store.
/// </para>
/// <para>
