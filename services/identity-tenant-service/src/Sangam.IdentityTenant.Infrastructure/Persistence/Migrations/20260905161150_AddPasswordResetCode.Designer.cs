...
namespace Sangam.IdentityTenant.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260905161150_AddPasswordResetCode")]
            ...
            modelBuilder.Entity("Sangam.IdentityTenant.Domain.Users.User", b =>
                {
                    ...
                    b.OwnsOne("Sangam.IdentityTenant.Domain.Users.PasswordResetCode", "PasswordResetCode", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<DateTimeOffset>("IssuedAt")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("password_reset_code_issued_at");
