...
public sealed class PathshalaDbContext(
    DbContextOptions<PathshalaDbContext> options,
    ITenantContext tenantContext)
    : DbContext(options)
{
    private static readonly JsonSerializerOptions PayloadSerializerOptions = new(JsonSerializerDefaults.Web);

    public DbSet<Domain.Pathshalas.Pathshala> Pathshalas => Set<Domain.Pathshalas.Pathshala>();

    public DbSet<AcademicSession> Sessions => Set<AcademicSession>();

    public DbSet<PathshalaClass> Classes => Set<PathshalaClass>();

    public DbSet<StudentEnrolment> Enrolments => Set<StudentEnrolment>();
    ...
    {
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(PathshalaDbContext).Assembly);
